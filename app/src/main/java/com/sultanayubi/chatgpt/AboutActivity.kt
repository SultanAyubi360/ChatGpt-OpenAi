...
import com.sultanayubi.chatgpt.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdView = findViewById(R.id.aboutban)
        ...
        bottomNav = findViewById(com.sultanayubi.chatgpt.R.id.bottom_navigation) as BottomNavigationView
        ...
        bottomNav.setSelectedItemId(com.sultanayubi.chatgpt.R.id.about);
